...
# Ball Positions
ypos = (0.5275, 0.71)  # Yellow
wpos = (0.81, 0.61)  # White
rpos = (0.71, 0.83)  # Red
...
cue = pt.Cue(cue_ball_id="yellow", specs=cue_specs)
...
phi = 55 #pt.aim.at_ball(system, "red", cut=25)
...
system.save(path="../../tests/ruleset/test_shots/03a_test_shot_ispoint.msgpack")
