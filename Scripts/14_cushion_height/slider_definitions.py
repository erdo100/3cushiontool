...
def create_physics_sliders(slider_frame, physics_params, update_plot):
    ...
    return physics_u_slide_slider, physics_u_roll_slider, physics_u_sp_prop_slider, physics_e_ballball_slider, physics_e_cushion_slider, physics_f_cushion_slider, physics_cushion_height_slider
