...
physics_u_ballball_slider = Scale(slider_frame, from_=0, to=0.1, resolution=0.001, orient=HORIZONTAL, label="Physics u_ballball", length=slider_length, command=update_plot)
physics_u_ballball_slider.set(physics_params['u_ballball'])
physics_u_ballball_slider.pack()
